...
class ErrorHandler {
  ...
  static categorizeError(error, context) {
    ...
    if (message.includes('auth') || message.includes('login') || 
        message.includes('sign') || message.includes('password') ||
    ...
    if (message.includes('DOM') || message.includes('element') ||
        ...
        context.includes('ui') || context.includes('popup') ||
  ...
  static shouldRetry(errorInfo) {
    ...
    if (type === this.ERROR_TYPES.VALIDATION || severity === this.SEVERITY.CRITICAL) {
      return false
    }
  ...
  static shouldShowToUser(errorInfo) {
    ...
    if (severity === this.SEVERITY.CRITICAL || severity === this.SEVERITY.HIGH) {
      return true
    }

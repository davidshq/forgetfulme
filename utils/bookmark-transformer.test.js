...
class BookmarkTransformerTest {
  ...
  static testTransformMultiple() {
    ...
    if (!Array.isArray(result) || result.length !== 2) {
      throw new Error('transformMultiple should return array with correct length')
    }
...
if (typeof window !== 'undefined' && window.BookmarkTransformer) {
  console.log('🧪 BookmarkTransformer tests available. Run BookmarkTransformerTest.runAllTests() to test.')
} 
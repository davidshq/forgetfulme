...
describe('Bookmark Management Page - Button Integration Tests', () => {
  ...
  describe('Full button workflow', () => {
    it('should handle edit button click through to showing edit interface', async () => {
      ...
      const { showMainInterface, showEditInterface } = await import(
        '../../bookmark-management/index.js'
      );
      ...
      const editButton = bookmarksList.querySelector(
        'button.secondary[aria-label*="Edit"]'
      );
    ...
    it('should handle delete button click and show confirmation', async () => {
      ...
      const { createBookmarkListItem } = await import(
        '../../bookmark-management/ui/render.js'
      );
    ...
    it('should handle open button click with Chrome API', async () => {
      ...
      const { openBookmark } = await import(
        '../../bookmark-management/events/handlers.js'
      );
